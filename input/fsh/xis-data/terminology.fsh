...
Description: """Dit codesysteem bevat concepten die het roltype bepalen van een zorgverlener of andere medewerker in de gezondheidszorg. De onderstaande tabel is een invulling van het HL7v3 vocabulaire domein “RoleCode” en wel specifiek het concept “AssignedRoleType”. De bron voor deze lijst is het [Certificate Practice Statement (CPS)](https://www.zorgcsp.nl/certification-practice-statement-cps) van het [UZI-register](https://www.uziregister.nl/) (Unieke Zorgverlener Identificatie). 
* 2024-06-29 Update op basis van UZI-Register CPS 11.7 Wijziging: 01.071 "Spoedeisende hulp arts" heet nu "Spoedeisende hulp arts (SEH-arts)", Tabel 23 Vervallen 30.065 Verpl. spec. prev. zorg bij som. aandoeningen (per 01-07-2023) en 30.069 Verpl. spec. chronische zorg bij som. aandoeningen (per 01-07-2023). Let op dat 30.065 onterecht al vervallen stond in de vorige versie van dit codesysteem, terwijl 30.066 dat had moeten zijn. Beide zijn dus intussen vervallen
* 2022-06-27 Update op basis van UZI-Register CPS 11.4 Tabel 23 Specialismen Verpleegkundige: 30.076 Verpl. spec. algemene gezondheidszorg (per 01-01-2021) toegevoegd, 30.067 Verpl. spec. intensieve zorg bij som. aandoeningen (per 01-01-2021) vervallen, 30.065 Verpl. prev. intensieve zorg bij som. aandoeningen (per 01-01-2021) vervallen
* 2020-04-01 Update op basis van UZI-Register CPS 9.8 Artikel 36a codes toegevoegd (82.000 Klinisch technoloog, 80.000 Bachelor medisch hulpverlener, 79.000 Geregistreerd-mondhygiënist (per 01-07-2020))
* 2019-12-01 Update op basis van UZI-Register CPS 9.7 31.000 Orthopedagoog-generalist (per 01-01-2020)
* 2018-09-10 Update op basis van UZI-Register CPS 9.1 81.000 Physician Assistant
* Tevens opgenomen na grondigere controle, maar geen releasenotes voor gevonden in CPS: 01.002 was "Internist-Allergoloog" en is nu "Allergoloog (gesloten register)", 01.062 "Internist-Allergoloog (gesloten register)" toegevoegd, 01.020 was "Arts klinische chemie" en is nu "Arts klinische chemie (gesloten register)", 01.050 was "Zenuwarts" en is nu "Zenuwarts (gesloten register)"
* 2017-08-01 Update op basis van UZI-Register CPS 7.1 01.099 Zorgverlener Andere zorg
* 2016-04-01 Update op basis van UZI-register CPS 6.0 17.075 Openbaar apotheker
* 2015-09-01 Update op basis van UZI-Register CPS 5.8 01.074 Sportarts
* 2012-01-18 Update op basis van UZI-Register CPS 5.0 30.069 Verpl. spec. geestelijke gezondheidszorg, 01.070 Jeugdarts, 01.071 Spoedeisende hulp arts, 84.000 Klinisch fysicus
* 2007-10-01 Update op basis van UZI-Register CPS 3.2 01.004 Apotheekhoudend huisarts"""
* ^meta.profile = "http://hl7.org/fhir/StructureDefinition/shareablecodesystem"
* ^language = #nl-NL
* ^text.status = #empty
* ^text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\" lang=\"nl-NL\" xml:lang=\"nl-NL\">Definitie-resources zijn niet voorzien van een narrative. Een menselijk leesbare versie is te vinden via de implementation guide(s) waarin deze resource gebruikt wordt.</div>"
* ^extension.url = "http://hl7.org/fhir/StructureDefinition/resource-effectivePeriod"
* ^extension.valuePeriod.start = "2024-01-29T00:00:00Z"
* ^url = "http://fhir.nl/fhir/NamingSystem/uzi-rolcode"
...
* ^contact.telecom.value = "070-3173450"
* ^caseSensitive = false
* ^content = #complete
* ^count = 84
...
* #30.065 ^property[=].valueCode = #01.000
...
* #30.066 ^property[=].valueCode = #01.000
...
* #30.067 ^property[=].valueCode = #01.000
...
* #30.068 ^property[=].valueCode = #01.000
...
* #30.069 ^property[=].valueCode = #01.000
...
* #30.076 ^property[=].valueCode = #01.000
...
Instance: uzi-rolcode-to-informationsensitivitypolicy
InstanceOf: ConceptMap
Usage: #definition
* url = "http://example.org/fhir/ConceptMap/uzi-rolcode-to-informationsensitivitypolicy"
* identifier.system = "urn:ietf:rfc:3986"
* identifier.value = "urn:uuid:bb1bc368-6dad-47ed-9101-898573affbf7"
* name = "PractitionerRole code (UZI rolcode) to Information Sensitivity Policy for Authorization"
* status = #draft
* experimental = true
* description = "PractitionerRole code (UZI rolcode) to Information Sensitivity Policy for Authorization"
* purpose = "Authorization of practitioners to access sensitive information"
* sourceCanonical = "http://decor.nictiz.nl/fhir/ValueSet/2.16.840.1.113883.2.4.3.11.60.1.11.2--20200401000000"
* targetCanonical = "http://terminology.hl7.org/ValueSet/v3-InformationSensitivityPolicy"
* group.source = "http://fhir.nl/fhir/NamingSystem/uzi-rolcode"
* group.target = $v3-ActCode

* group.element[0].code = #01.045
* group.element[=].display = "Uroloog"
* group.element[=].target[+].code = #ETH
* group.element[=].target[=].display = "substance abuse information sensitivity"
* group.element[=].target[=].equivalence = #specializes
* group.element[=].target[+].code = #GDIS
* group.element[=].target[=].display = "genetic disease information sensitivity"
* group.element[=].target[=].equivalence = #specializes
* group.element[=].target[+].code = #SDV
* group.element[=].target[=].display = "sexual assault, abuse, or domestic violence information sensitivity"
* group.element[=].target[=].equivalence = #specializes
* group.element[=].target[+].code = #SEX
* group.element[=].target[=].display = "sexuality and reproductive health information sensitivity"
* group.element[=].target[=].equivalence = #specializes
* group.element[=].target[+].code = #STD
* group.element[=].target[=].display = "sexually transmitted disease information sensitivity"
* group.element[=].target[=].equivalence = #specializes

* group.element[+].code = #30.076
* group.element[=].display = "Verpl. spec. algemene gezondheidszorg"
* group.element[=].target[+].code = #ETH
* group.element[=].target[=].display = "substance abuse information sensitivity"
* group.element[=].target[=].equivalence = #specializes
* group.element[=].target[+].code = #SDV
...
* group.element[=].target[=].display = "behavioral health information sensitivity"
* group.element[=].target[=].equivalence = #specializes
* group.element[=].target[+].code = #MH
* group.element[=].target[=].display = "mental health information sensitivity"
* group.element[=].target[=].equivalence = #specializes
...
InstanceOf: Bundle
Usage: #example
Title: "9.01 Bundle of terminology resources"
* type = #transaction
* insert BundleEntry(uzi-rolcode, #PUT, CodeSystem/uzi-rolcode)
* insert BundleEntry(uzi-rolcode-to-informationsensitivitypolicy, #PUT, ConceptMap/uzi-rolcode-to-informationsensitivitypolicy)