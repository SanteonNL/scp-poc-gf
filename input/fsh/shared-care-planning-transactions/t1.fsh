...
* insert RefIdentifierContained(focus, ServiceRequest, org1-servicerequest-telemonitoring, $uuid, urn:uuid:37063bd0-d6bb-4fe0-b73c-26532f297d4b, $ura, URA-1)
* reasonCode.coding = $sct#84114007 "Hartfalen"
* insert RefIdentifier(for, Patient, 1, $bsn, 111222333, $ura, URA-1, org1)
* insert RefIdentifierContained(requester, PractitionerRole, org1-cardiologist-carolinevandijk, $uzi, UZI-1, $ura, URA-1)
