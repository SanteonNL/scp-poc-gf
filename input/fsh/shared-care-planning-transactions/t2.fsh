Instance: cps-sub-organization2
InstanceOf: Subscription
Usage: #example
Title: "1.04.1 Subscription Organization 2"
Description: "Subscription to receive notifications of instance-id's where the Organization 2 is a participant. E.g. as a CareTeam.participant.member, Task.owner or Task.filler"
...
Instance: cps-sub-organization1
InstanceOf: Subscription
Usage: #example
Title: "1.04.2 Subscription Organization 1"
Description: "Subscription to receive notifications of instance-id's where Organization 1 is a participant. E.g. as a CareTeam.participant.member, Task.owner or Task.filler"
...
InstanceOf: Bundle
Usage: #example
Title: "1.05.1 notification bundle for Organization 1"
...
Usage: #example
Title: "1.05.2 notification bundle parameter for Organization 1"
